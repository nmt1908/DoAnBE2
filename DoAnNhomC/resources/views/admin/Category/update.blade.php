    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('admin.listcategories') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.postUpdateCategories') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Thêm token CSRF -->
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option value="1" @if($category->status == '1') selected @endif>Action</option>
                                    <option value="0" @if($category->status == '0') selected @endif>Block</option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{ route('admin.listcategories') }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
...
@if($category->image)
    <img src="{{ asset('category-image/images/' . $category->image) }}" id="currentImage" style="display: none;">
    <div id="imagePreview"></div>
@else
