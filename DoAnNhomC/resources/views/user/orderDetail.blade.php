                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="mb-4 fs-sm fw-bold">
                                                <a class="text-body" href="product.html">{{$value->product->product_name}}</a> <br>
                                                <span class="text-muted">${{$value->product->price}}</span>
                                            </p>
                                        </div>
                    ...
                    <div class="card card-lg mb-5 mt-3">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li class="list-group-item d-flex">
                                    <span>Shipping</span>
                                    <span class="ms-auto">$20.00</span>
                                </li>
                                <li class="list-group-item d-flex fs-lg fw-bold">
                                    <span>Total</span>
                                    <span class="ms-auto">${{$totalAll}}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
