...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('user-acess/css/slick.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('user-acess/css/slick-theme.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('user-acess/css/video-js.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('user-acess/css/style.css') }}?v={{ rand(111,999) }}" />
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-card">
                        <h3>Chi nhánh 1</h3>
                        <p>Phục vụ 24/24 <br>
                            65 Võ Văn Ngân,P.Linh Trung,Thủ Đức ,TPHCM <br>
                            21211tt1227@mail.tdc.edu.vn <br>
                            0908786359</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="footer-card">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('page',$Page->slug) }}" title="{{$Page->name}}">{{$Page->name}}</a>
                            </li>
                            @endforeach
                        </ul>
                        @endif
